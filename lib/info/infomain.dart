...
class _MyHomePageState extends State<infoMain> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
          ...
          Text('Информация', style: boldText)
              : Container(
                        ...
                        children: [
                          GestureDetector(
                            ...
                            child:Container(
                              ...
                              decoration: BoxDecoration(
                                border: Border(
                                  bottom: BorderSide(width: 2.0, color: _actionSW == false ? Color(0xFF32D74B) : Colors.white),
                                ),
                              ),
                              width: MediaQuery.of(context).size.width / 2,
                              child:Text('Услуги', style: _actionSW == true ? nameSubTitle : nameSubTitleDark, textAlign: TextAlign.center, ),),),
                          GestureDetector(
                            onTap: (){
                              setState(() {
                                _actionSW = !_actionSW;
                            ...
                            child:Container(
                              ...
                              decoration: BoxDecoration(
                                border: Border(
                                  bottom: BorderSide(width: 2.0, color: _actionSW == true ? Color(0xFF32D74B) : Colors.white),
                                ),

                              ),
                              width: MediaQuery.of(context).size.width / 2,
                              child:Text('Акции', style: _actionSW == false ? nameSubTitle : nameSubTitleDark, textAlign: TextAlign.center,  ),),)
                        ])
                ),
                Container(
                    margin: const EdgeInsets.fromLTRB(0,0,0,0),
                                ...
                                child:Row(
                                    children: [
                                      GestureDetector(
                                        ...
                                        child: Text(jobs[index]['name'], style: nameSubTitleDark),),
                                      Spacer(),
