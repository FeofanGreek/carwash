...
import '../styles.dart';
import 'automotivenum.dart';
import 'jobselect.dart';

//var _date = DateTime.now();
var _date = DateTime.parse('2021-08-11 06:00:00.000');
var _timeStart = DateTime.parse('2021-08-11 00:00:00.000');
var _timeEnd =  _timeStart.add(Duration(hours: 1));
//var _timeStart = DateTime.now();
//var _timeEnd = DateTime.now();
int _postNum = 0;
int _maxPostCol = ordersBorn[0]['postCol'];
int _status = 0;
List<String> carsTypes = ['Не выбран', 'Легковой', 'Внедорожник', 'Микроавтобус', 'Грузовик', 'Пикап', 'Коммерческий', 'Мотоцикл', 'Ковер'];
String carTypeSelected = 'Легковой';
List<String> carsBrands = ['Не выбран', 'Мерседес', 'Газель', 'Тойота', 'Тесла', 'Ниссан', 'Хонда', 'Крайслер', 'Нива'];
String carBrandSelected = 'Газель';
List<String> carsModels = ['Не выбран', 'W140', 'W210', 'W202', 'Vesta', 'X-Ray', 'Leaf', 'Spyker', '4x4'];
...
class _MyHomePageState extends State<orderMain> {
  @override
  ...
  addOrder(){
    ...
    if(top == false) {
      ...
      ordersBorn[0]['orderItems'].add({'Start' : timeStart.toString(), 'End' : timeEnd.toString(), 'postNum' : postNum, 'status': _status, 'edit' : 1, 'selected' : false, 'carTypeSelected' : carTypeSelected, 'carBrandSelected' : carBrandSelected, 'carModelSelected' : carModelSelected, 'selectedColor' : selectedColorIndex, 'carNumber' : carNumber, 'carRegion' : carRegion, 'personName' : personName, 'personSyrname' : personSyrname, 'personPatronym' : personPatronym, 'personPhone' : personPhone, 'staffSelected' : staffSelected,  'jobds' : selectJobs()});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
          ...
          title: Text('Создание записи', style: boldText),
          actions: [
          Container(
                                    ...
                                    TextButton(
                                        onPressed: () {
                                          DatePicker.showTimePicker(context,
                                              ...
                                              showTitleActions: true,
                                              currentTime: _timeStart.add(Duration(minutes: 1)),
                                              theme: DatePickerTheme(
                                                  cancelStyle: TextStyle(color: Colors.blue, fontSize: 16),
                                                  headerColor: Colors.white,
                                                  backgroundColor: Colors.white,
                                    ...
                                    TextButton(
                                        onPressed: () {
                                          DatePicker.showTimePicker(context,
                                              showSecondsColumn: false,
                                              showTitleActions: true,
                                              currentTime: _timeStart.add(Duration(hours: 1)),
                                              theme: DatePickerTheme(
                                                  cancelStyle: TextStyle(color: Colors.blue, fontSize: 16),
                                                  headerColor: Colors.white,
                                                  backgroundColor: Colors.white,
